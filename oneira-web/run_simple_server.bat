...
start "AI Backend" cmd /k "cd /d c:\Projects\dream-fortune-ai\backend && venv\Scripts\activate && python main.py"

echo Starting Frontend Host (Port 5500)...
start "Frontend Host" cmd /k "python -m http.server 5500 --directory c:\Projects\oneira-web"
